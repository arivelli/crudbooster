<?php namespace arivelli\crudbooster\commands;
...
class CrudboosterInstallationCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->confirm('Do you have setting the database configuration at .env ?')) {
            ...
            $this->call('vendor:publish', ['--provider' => 'arivelli\crudbooster\CRUDBoosterServiceProvider']);
            ...
            $configLFMModified = str_replace("['web','auth']", "['web','\arivelli\crudbooster\middlewares\CBBackend']", $configLFM);
